...
public class EmployeeDao {
    ...
    public Employee getEmployeeById(int id){
        javax.persistence.Query q=entityManager.createNativeQuery("select * from emp where emp_Id= :id", Employee.class);
        q.setParameter("id",id);
        return (Employee) q.getSingleResult();
    }

    public List<Employee> getEmployeeList(int id){
        javax.persistence.Query q=entityManager.createNativeQuery("select * from emp", Employee.class);
